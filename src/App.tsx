...
const SelectorCustom = ()=>{
  return (
    <label>
      Pick a fruit:
      <input type="search" />
      <select onInput={(e)=>{console.log(e)}} inputMode='search' style={{borderRadius:"0px"}} suppressContentEditableWarning contentEditable name="selectedFruit">
        <option className="options" value="apple">
          Apple
        </option>
        <option value="banana">Banana</option>
        <option value="banana2">Banana</option>
